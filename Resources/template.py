...
#MixNode Cluster DyeColor A
    ...
    DyeColor1MixNodeB.inputs[2].default_value = (CPrime2.X, CPrime2.Y, CPrime2.Z, CPrime2.W) #BIOS ClothPrimary Color [X,X,X,X]
    ...
    DyeColor1MixNodeC.inputs[2].default_value = (CSecon2.X, CSecon2.Y, CSecon2.Z, CSecon2.W) #BIOS ClothSecondary Color [X,X,X,X]
    ...
    DyeColor1MixNodeD.inputs[2].default_value = (CPrime3.X, CPrime3.Y, CPrime3.Z, CPrime3.W) #BIOS SuitPrimary Color [X,X,X,X]
    ...
    DyeColor1MixNodeE.inputs[2].default_value = (CSecon3.X, CSecon3.Y, CSecon3.Z, CSecon3.W) #BIOS SuitSecondary Color [X,X,X,X]
...
#MixNode Cluster DyeColor B
    ...
    DyeColor2MixNodeB.inputs[2].default_value = (CPrimeWear2.X, CPrimeWear2.Y, CPrimeWear2.Z, CPrimeWear2.W) #BIOS ClothPrimary Wear Color [X,X,X,X]
    ...
    DyeColor2MixNodeC.inputs[2].default_value = (CSeconWear2.X, CSeconWear2.Y, CSeconWear2.Z, CSeconWear2.W) #BIOS ClothSecondary Wear Color [X,X,X,X]
    ...
    DyeColor2MixNodeD.inputs[2].default_value = (CPrimeWear3.X, CPrimeWear3.Y, CPrimeWear3.Z, CPrimeWear3.W) #BIOS SuitPrimary Wear Color [X,X,X,X]
    ...
    DyeColor2MixNodeE.inputs[2].default_value = (CSeconWear3.X, CSeconWear3.Y, CSeconWear3.Z, CSeconWear3.W) #BIOS SuitSecondary Wear Color [X,X,X,X]
...
#MixNode Cluster Emission Parameters
    ...
    Emission_A.inputs[2].default_value = (CPrimeEmit1.X, CPrimeEmit1.Y, CPrimeEmit1.Z, CPrimeEmit1.W) #BIOS ArmorPrimary Emissive Tint Color and Intensity Bias [X,X,X,X]
    Emission_A.inputs[1].default_value = (CSeconEmit1.Y, CSeconEmit1.Y, CSeconEmit1.Z, CSeconEmit1.W) #BIOS ArmorSecondary Emissive Tint Color and Intensity Bias [X,X,X,X]
    Emission_A.label = "Emission"
    Emission_A.location = (500,-2020)
    Emission_A.hide = (1)

    Emission_B = test_group.nodes.new(type= 'ShaderNodeMixRGB')
    Emission_B.inputs[2].default_value = (CPrimeEmit2.X, CPrimeEmit2.Y, CPrimeEmit2.Z, CPrimeEmit2.W) #BIOS ClothPrimary Emissive Tint Color and Intensity Bias [X,X,X,X]
    Emission_B.label = "Emission"
    Emission_B.location = (500,-2050)
    Emission_B.hide = (1)

    Emission_C = test_group.nodes.new(type= 'ShaderNodeMixRGB')
    Emission_C.inputs[2].default_value = (CSeconEmit2.X, CSeconEmit2.Y, CSeconEmit2.Z, CSeconEmit2.W) #BIOS ClothSecondary Emissive Tint Color and Intensity Bias [X,X,X,X]
    Emission_C.label = "Emission"
    Emission_C.location = (500,-2080)
    Emission_C.hide = (1)

    Emission_D = test_group.nodes.new(type= 'ShaderNodeMixRGB')
    Emission_D.inputs[2].default_value = (CPrimeEmit3.X, CPrimeEmit3.Y, CPrimeEmit3.Z, CPrimeEmit3.W) #BIOS SuitPrimary Emissive Tint Color and Intensity Bias [X,X,X,X]
    Emission_D.label = "Emission"
    Emission_D.location = (500,-2110)
    Emission_D.hide = (1)

    Emission_E = test_group.nodes.new(type= 'ShaderNodeMixRGB')
    Emission_E.inputs[2].default_value = (CSeconEmit3.X, CSeconEmit3.Y, CSeconEmit3.Z, CSeconEmit3.W) #BIOS SuitSecondary Emissive Tint Color and Intensity Bias [X,X,X,X]
...
#Wear Remap XYZ Nodes
    ...
    Wear_Remap01.inputs[0].default_value = (PrimeWearMap1.X) #BIOS ArmorPrimary Wear Remap: [X,_,_,_]
    Wear_Remap01.inputs[1].default_value = (PrimeWearMap1.Y) #BIOS ArmorPrimary Wear Remap: [_,X,_,_]
    Wear_Remap01.inputs[2].default_value = (PrimeWearMap1.Z) #BIOS ArmorPrimary Wear Remap: [_,_,X,_]
    Wear_Remap01.location = (0,-300)
    Wear_Remap01.hide = (0)

    Wear_Remap02 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap02.label = "WearRemap"
    Wear_Remap02.inputs[0].default_value = (PrimeWearMap1.W) #BIOS ArmorPrimary Wear Remap: [_,_,_,X]
    ...
    Wear_Remap03.inputs[0].default_value = (SeconWearMap1.X) #BIOS ArmorSecondary Wear Remap: [X,_,_,_]
    Wear_Remap03.inputs[1].default_value = (SeconWearMap1.Y) #BIOS ArmorSecondary Wear Remap: [_,X,_,_]
    Wear_Remap03.inputs[2].default_value = (SeconWearMap1.Z) #BIOS ArmorSecondary Wear Remap: [_,_,X,_]
    Wear_Remap03.location = (0,-540)
    Wear_Remap03.hide = (0)

    Wear_Remap04 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap04.label = "WearRemap"
    Wear_Remap04.inputs[0].default_value = (SeconWearMap1.W) #BIOS ArmorSecondary Wear Remap: [_,_,_,X]
    ...
    Wear_Remap05.inputs[0].default_value = (PrimeWearMap2.X) #BIOS ClothPrimary Wear Remap: [X,_,_,_]
    Wear_Remap05.inputs[1].default_value = (PrimeWearMap2.Y) #BIOS ClothPrimary Wear Remap: [_,X,_,_]
    Wear_Remap05.inputs[2].default_value = (PrimeWearMap2.Z) #BIOS ClothPrimary Wear Remap: [_,_,X,_]
    Wear_Remap05.location = (0,-780)
    Wear_Remap05.hide = (0)

    Wear_Remap06 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap06.label = "WearRemap"
    Wear_Remap06.inputs[0].default_value = (PrimeWearMap2.W) #BIOS ClothPrimary Wear Remap: [_,_,_,X]
    ...
    Wear_Remap07.inputs[0].default_value = (SeconWearMap2.X) #BIOS ClothSecondary Wear Remap: [X,_,_,_]
    Wear_Remap07.inputs[1].default_value = (SeconWearMap2.Y) #BIOS ClothSecondary Wear Remap: [_,X,_,_]
    Wear_Remap07.inputs[2].default_value = (SeconWearMap2.Z) #BIOS ClothSecondary Wear Remap: [_,_,X,_]
    Wear_Remap07.location = (0,-1020)
    Wear_Remap07.hide = (0)

    Wear_Remap08 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap08.label = "WearRemap"
    Wear_Remap08.inputs[0].default_value = (SeconWearMap2.W) #BIOS ClothSecondary Wear Remap: [_,_,_,X]
    ...
    Wear_Remap09.inputs[0].default_value = (PrimeWearMap3.X) #BIOS SuitPrimary Wear Remap: [X,_,_,_]
    Wear_Remap09.inputs[1].default_value = (PrimeWearMap3.Y) #BIOS SuitPrimary Wear Remap: [_,X,_,_]
    Wear_Remap09.inputs[2].default_value = (PrimeWearMap3.Z) #BIOS SuitPrimary Wear Remap: [_,_,X,_]
    Wear_Remap09.location = (0,-1260)
    Wear_Remap09.hide = (0)

    Wear_Remap10 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap10.label = "WearRemap"
    Wear_Remap10.inputs[0].default_value = (PrimeWearMap3.W) #BIOS SuitPrimary Wear Remap: [_,_,_,X]
    ...
    Wear_Remap11.inputs[0].default_value = (SeconWearMap3.X) #BIOS SuitSecondary Wear Remap: [X,_,_,_]
    Wear_Remap11.inputs[1].default_value = (SeconWearMap3.Y) #BIOS SuitSecondary Wear Remap: [_,X,_,_]
    Wear_Remap11.inputs[2].default_value = (SeconWearMap3.Z) #BIOS SuitSecondary Wear Remap: [_,_,X,_]
    Wear_Remap11.location = (0,-1500)
    Wear_Remap11.hide = (0)

    Wear_Remap12 = test_group.nodes.new(type= 'ShaderNodeCombineXYZ')
    Wear_Remap12.label = "WearRemap"
    Wear_Remap12.inputs[0].default_value = (SeconWearMap3.W) #BIOS SuitSecondary Wear Remap: [_,_,_,X]
...
#Gloss Vector A+B Remap XYZ Nodes
    ...
    Gloss_Remap01.inputs[0].default_value = (PrimeRoughMap1.X) #BIOS ArmorPrimary Roughness Remap [X,_,_,_]
    Gloss_Remap01.inputs[1].default_value = (PrimeRoughMap1.Y) #BIOS ArmorPrimary Roughness Remap [_,X,_,_] 
    Gloss_Remap01.inputs[2].default_value = (PrimeRoughMap1.Z) #BIOS ArmorPrimary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap02.inputs[0].default_value = (PrimeRoughMap1.W) #BIOS ArmorPrimary Roughness Remap [_,_,_,X]
    Gloss_Remap02.inputs[1].default_value = (PrimeWornRoughMap1.X) #BIOS ArmorPrimary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap02.inputs[2].default_value = (PrimeWornRoughMap1.Y) #BIOS ArmorPrimary Worn Roughness Remap [_,X,_,_]
    ...
    Gloss_Remap03.inputs[0].default_value = (SeconRoughMap1.X) #BIOS ArmorSecondary Roughness Remap [X,_,_,_]
    Gloss_Remap03.inputs[1].default_value = (SeconRoughMap1.Y) #BIOS ArmorSecondary Roughness Remap [_,X,_,_]
    Gloss_Remap03.inputs[2].default_value = (SeconRoughMap1.Z) #BIOS ArmorSecondary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap04.inputs[0].default_value = (SeconRoughMap1.W) #BIOS ArmorSecondary Roughness Remap [_,_,_,X]
    Gloss_Remap04.inputs[1].default_value = (SeconWornRoughMap1.X) #BIOS ArmorSecondary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap04.inputs[2].default_value = (SeconWornRoughMap1.Y) #BIOS ArmorSecondary Worn Roughness Remap [_,X,_,_]
    ...
    Gloss_Remap05.inputs[0].default_value = (PrimeRoughMap2.X) #BIOS ClothPrimary Roughness Remap [X,_,_,_]
    Gloss_Remap05.inputs[1].default_value = (PrimeRoughMap2.Y) #BIOS ClothPrimary Roughness Remap [_,X,_,_]
    Gloss_Remap05.inputs[2].default_value = (PrimeRoughMap2.Z) #BIOS ClothPrimary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap06.inputs[0].default_value = (PrimeRoughMap2.W) #BIOS ClothPrimary Roughness Remap [_,_,_,X]
    Gloss_Remap06.inputs[1].default_value = (PrimeWornRoughMap2.X) #BIOS ClothPrimary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap06.inputs[2].default_value = (PrimeWornRoughMap2.Y) #BIOS ClothPrimary Worn Roughness Remap [_,X,_,_]
    ...
    Gloss_Remap07.inputs[0].default_value = (SeconRoughMap2.X) #BIOS ClothSecondary Roughness Remap [X,_,_,_]
    Gloss_Remap07.inputs[1].default_value = (SeconRoughMap2.Y) #BIOS ClothSecondary Roughness Remap [_,X,_,_]
    Gloss_Remap07.inputs[2].default_value = (SeconRoughMap2.Z) #BIOS ClothSecondary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap08.inputs[0].default_value = (SeconRoughMap2.W) #BIOS ClothSecondary Roughness Remap [_,_,_,X]
    Gloss_Remap08.inputs[1].default_value = (SeconWornRoughMap2.X) #BIOS ClothSecondary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap08.inputs[2].default_value = (SeconWornRoughMap2.Y) #BIOS ClothSecondary Worn Roughness Remap [_,X,_,_]
    ...
    Gloss_Remap09.inputs[0].default_value = (PrimeRoughMap3.X) #BIOS SuitPrimary Roughness Remap [X,_,_,_]
    Gloss_Remap09.inputs[1].default_value = (PrimeRoughMap3.Y) #BIOS SuitPrimary Roughness Remap [_,X,_,_]
    Gloss_Remap09.inputs[2].default_value = (PrimeRoughMap3.Z) #BIOS SuitPrimary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap10.inputs[0].default_value = (PrimeRoughMap3.W) #BIOS SuitPrimary Roughness Remap [_,_,_,X]
    Gloss_Remap10.inputs[1].default_value = (PrimeWornRoughMap3.X) #BIOS SuitPrimary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap10.inputs[2].default_value = (PrimeWornRoughMap3.X) #BIOS SuitPrimary Worn Roughness Remap [_,X,_,_]
    ...
    Gloss_Remap11.inputs[0].default_value = (SeconRoughMap3.X) #BIOS SuitSecondary Roughness Remap [X,_,_,_]
    Gloss_Remap11.inputs[1].default_value = (SeconRoughMap3.Y) #BIOS SuitSecondary Roughness Remap [_,X,_,_]
    Gloss_Remap11.inputs[2].default_value = (SeconRoughMap3.Z) #BIOS SuitSecondary Roughness Remap [_,_,X,_]
    ...
    Gloss_Remap12.inputs[0].default_value = (SeconRoughMap3.W) #BIOS SuitSecondary Roughness Remap [_,_,_,X]
    Gloss_Remap12.inputs[1].default_value = (SeconWornRoughMap3.X) #BIOS SuitSecondary Worn Roughness Remap [X,_,_,_]
    Gloss_Remap12.inputs[2].default_value = (SeconWornRoughMap1.Y) #BIOS SuitSecondary Worn Roughness Remap [_,X,_,_]
...
#Gloss Vector C Remap XYZ Nodes
    ...
    Gloss_Remap13.inputs[0].default_value = (PrimeWornRoughMap1.Z) #BIOS ArmorPrimary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap13.inputs[1].default_value = (PrimeWornRoughMap1.W) #BIOS ArmorPrimary Worn Roughness Remap [_,_,_,X]
    ...
    Gloss_Remap14.inputs[0].default_value = (SeconWornRoughMap1.Z) #BIOS ArmorSecondary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap14.inputs[1].default_value = (SeconWornRoughMap1.W) #BIOS ArmorSecondary Worn Roughness Remap [_,_,_,X]
    ...
    Gloss_Remap15.inputs[0].default_value = (PrimeWornRoughMap2.Z) #BIOS ClothPrimary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap15.inputs[1].default_value = (PrimeWornRoughMap2.W) #BIOS ClothPrimary Worn Roughness Remap [_,_,_,X]
    ...
    Gloss_Remap16.inputs[0].default_value = (SeconWornRoughMap2.Z) #BIOS ClothSecondary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap16.inputs[1].default_value = (SeconWornRoughMap2.W) #BIOS ClothSecondary Worn Roughness Remap [_,_,_,X]
    ...
    Gloss_Remap17.inputs[0].default_value = (PrimeWornRoughMap3.Z) #BIOS SuitPrimary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap17.inputs[1].default_value = (PrimeWornRoughMap3.W) #BIOS SuitPrimary Worn Roughness Remap [_,_,_,X]
    ...
    Gloss_Remap18.inputs[0].default_value = (SeconWornRoughMap3.Z) #BIOS SuitSecondary Worn Roughness Remap [_,_,X,_]
    Gloss_Remap18.inputs[1].default_value = (SeconWornRoughMap3.W) #BIOS SuitSecondary Worn Roughness Remap [_,_,_,X]
...
#Detail Normal Map Texture Nodes
    ...
    TiledNormalMapping01.inputs[1].default_value = (NormTrans1.Z, NormTrans1.W, 1.000) #BIOS Armor Detail Normal Transform [_,_,X,X] (These values go in the X and Y)
    TiledNormalMapping01.inputs[3].default_value = (NormTrans1.X, NormTrans1.Y, 1.000) #BIOS Armor Detail Normal Transform [X,X,_,_] (These values go in the X and Y)
    ...
    TiledNormalMapping02.inputs[1].default_value = (NormTrans2.Z, NormTrans2.W, 1.000) #BIOS Cloth Detail Normal Transform [_,_,X,X] (These values go in the X and Y)
    TiledNormalMapping02.inputs[3].default_value = (NormTrans2.X, NormTrans2.Y, 1.000) #BIOS Cloth Detail Normal Transform [X,X,_,_] (These values go in the X and Y)
    ...
    TiledNormalMapping03.inputs[1].default_value = (NormTrans3.Z, NormTrans3.W, 1.000) #BIOS Suit Detail Normal Transform [_,_,X,X] (These values go in the X and Y)
    TiledNormalMapping03.inputs[3].default_value = (NormTrans3.X, NormTrans3.Y, 1.000) #BIOS Suit Detail Normal Transform [X,X,_,_] (These values go in the X and Y)
...
#Detail Diffuse Texture Nodes
    ...
    TiledDiffuseMapping01.inputs[1].default_value = (DiffTrans1.Z, DiffTrans1.W, 1.000) #BIOS Armor Detail Diffuse Transform [_,_,X,X] (These values go in the X and Y)
    TiledDiffuseMapping01.inputs[3].default_value = (DiffTrans1.X, DiffTrans1.Y, 1.000) #BIOS Armor Detail Diffuse Transform [X,X,_,_] (These values go in the X and Y)
    ...
    TiledDiffuseMapping02.inputs[1].default_value = (DiffTrans2.Z, DiffTrans2.W, 1.000) #BIOS Cloth Detail Diffuse Transform [_,_,X,X] (These values go in the X and Y)
    TiledDiffuseMapping02.inputs[3].default_value = (DiffTrans2.X, DiffTrans2.Y, 1.000) #BIOS Cloth Detail Diffuse Transform [X,X,_,_] (These values go in the X and Y)
    ...
    TiledDiffuseMapping03.inputs[1].default_value = (DiffTrans3.Z, DiffTrans3.W, 1.000) #BIOS Suit Detail Diffuse Transform [_,_,X,X] (These values go in the X and Y)
    TiledDiffuseMapping03.inputs[3].default_value = (DiffTrans3.X, DiffTrans3.Y, 1.000) #BIOS Suit Detail Diffuse Transform [X,X,_,_] (These values go in the X and Y)
...
#Metalness/Specular/Iridescence Parameters
    ...
    MSI_01.inputs[0].default_value = (PrimeMatParams1.W) #BIOS ArmorPrimary_material_params [_,_,_,X]
    MSI_01.inputs[1].default_value = (PrimeMatParams1.Z) #BIOS ArmorPrimary_material_params [_,_,X,_]
    MSI_01.inputs[2].default_value = (PrimeAdvMatParams1.X) #BIOS Armorprimary_material_advanced_params [X,_,_,_]
    ...
    MSI_02.inputs[0].default_value = (SeconMatParams1.W) #BIOS ArmorSecondary_material_params [_,_,_,X]
    MSI_02.inputs[1].default_value = (SeconMatParams1.Z) #BIOS ArmorSecondary_material_params [_,_,X,_]
    MSI_02.inputs[2].default_value = (SeconAdvMatParams1.X) #BIOS ArmorSecondary_material_advanced_params [X,_,_,_]
    ...
    MSI_03.inputs[0].default_value = (PrimeMatParams2.W) #BIOS ClothPrimary_material_params [_,_,_,X]
    MSI_03.inputs[1].default_value = (PrimeMatParams2.Z) #BIOS ClothPrimary_material_params [_,_,X,_]
    MSI_03.inputs[2].default_value = (PrimeAdvMatParams2.X) #BIOS ClothPrimary_material_advanced_params [X,_,_,_]
    ...
    MSI_04.inputs[0].default_value = (SeconMatParams2.W) #BIOS ClothSecondary_material_params [_,_,_,X]
    MSI_04.inputs[1].default_value = (SeconMatParams2.Z) #BIOS ClothSecondary_material_params [_,_,X,_]
    MSI_04.inputs[2].default_value = (SeconAdvMatParams2.X) #BIOS ClothSecondary_material_advanced_params [X,_,_,_]
    ...
    MSI_05.inputs[0].default_value = (PrimeMatParams3.W) #BIOS SuitPrimary_material_params [_,_,_,X]
    MSI_05.inputs[1].default_value = (PrimeMatParams3.Z) #BIOS SuitPrimary_material_params [_,_,X,_]
    MSI_05.inputs[2].default_value = (PrimeAdvMatParams3.X) #BIOS SuitPrimary_material_advanced_params [X,_,_,_]
    ...
    MSI_06.inputs[0].default_value = (SeconMatParams3.W) #BIOS SuitSecondary_material_params [_,_,_,X]
    MSI_06.inputs[1].default_value = (SeconMatParams3.Z) #BIOS SuitSecondary_material_params [_,_,X,_]
    MSI_06.inputs[2].default_value = (SeconAdvMatParams3.X) #BIOS SuitSecondary_material_advanced_params [X,_,_,_]
...
#Worn Metalness/Specular/Iridescence Parameters
    ...
    MSI_07.inputs[0].default_value = (PrimeWornMatParams1.W) #BIOS ArmorPrimary_worn_material_params [_,_,_,X]
    MSI_07.inputs[1].default_value = (PrimeWornMatParams1.Z) #BIOS ArmorPrimary_worn_material_params [_,_,X,_]
    ...
    MSI_08.inputs[0].default_value = (SeconWornMatParams1.W) #BIOS ArmorSecondary_worn_material_params [_,_,_,X]
    MSI_08.inputs[1].default_value = (SeconWornMatParams1.Z) #BIOS ArmorSecondary_worn_material_params [_,_,X,_]
    ...
    MSI_09.inputs[0].default_value = (PrimeWornMatParams2.W) #BIOS ClothPrimary_worn_material_params [_,_,_,X]
    MSI_09.inputs[1].default_value = (PrimeWornMatParams2.Z) #BIOS ClothPrimary_worn_material_params [_,_,X,_]
    ...
    MSI_10.inputs[0].default_value = (SeconWornMatParams2.W) #BIOS ClothSecondary_worn_material_params [_,_,_,X]
    MSI_10.inputs[1].default_value = (SeconWornMatParams2.Z) #BIOS ClothSecondary_worn_material_params [_,_,X,_]
    ...
    MSI_11.inputs[0].default_value = (PrimeWornMatParams3.W) #BIOS SuitPrimary_worn_material_params [_,_,_,X]
    MSI_11.inputs[1].default_value = (PrimeWornMatParams3.Z) #BIOS SuitPrimary_worn_material_params [_,_,X,_]
    ...
    MSI_12.inputs[0].default_value = (SeconWornMatParams3.W) #BIOS SuitSecondary_worn_material_params [_,_,_,X]
    MSI_12.inputs[1].default_value = (SeconWornMatParams3.Z) #BIOS SuitSecondary_worn_material_params [_,_,X,_]
