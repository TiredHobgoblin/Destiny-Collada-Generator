...
Shader "SHADERNAMEENUM"
{
	Properties
	{
		...
		[NoScaleOffset]_DetailDiffuse01("DetailDiffuse01", 2D) = "gray" {}
		[NoScaleOffset][Normal]_DetailNormal01("Detail Normal 01", 2D) = "bump" {}
		[NoScaleOffset]_DetailDiffuse02("DetailDiffuse02", 2D) = "white" {}
		[NoScaleOffset][Normal]_DetailNormal02("Detail Normal 02", 2D) = "bump" {}
		[NoScaleOffset]_DetailDiffuse03("DetailDiffuse03", 2D) = "white" {}
		[NoScaleOffset][Normal]_DetailNormal03("Detail Normal 03", 2D) = "bump" {}
		[NoScaleOffset]_DetailDiffuse04("DetailDiffuse04", 2D) = "white" {}
		[NoScaleOffset][Normal]_DetailNormal04("Detail Normal 04", 2D) = "bump" {}
		[NoScaleOffset]_DetailDiffuse05("DetailDiffuse05", 2D) = "white" {}
		[NoScaleOffset][Normal]_DetailNormal05("Detail Normal 05", 2D) = "bump" {}
		[NoScaleOffset]_DetailDiffuse06("DetailDiffuse06", 2D) = "white" {}
		[NoScaleOffset][Normal]_DetailNormal06("Detail Normal 06", 2D) = "bump" {}
